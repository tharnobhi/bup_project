...
for filename in os.listdir(audio_path):
    if filename.endswith(".mp3"):
        ...
        date_time = filename.split("_")[0] + "_" + filename.split("_")[1] + "_" + filename.split("_")[2]+ "_" + filename.split("_")[3]+ "_" + filename.split("_")[4]  # extract the date and time from the filename
        ...
        times.append(date_time.split("_")[1] +"_"+ date_time.split("_")[2] +"_" + date_time.split("_")[3] +"_" + date_time.split("_")[4]  )
